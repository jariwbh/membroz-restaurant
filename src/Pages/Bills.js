                    ...
                    <main>
                        <div className="container-fluid">
                            <div className="row table-item-gutters">
                                <h1>Today's Bills</h1>
                                <GridComponent dataSource={data} gridLines="both" allowSorting={true} allowPaging={true} pageSettings={{ pageCount: 4, pageSizes: true }} allowResizing={true} allowReordering={true} >
                                    <ColumnsDirective>
                                        ...
                                        <ColumnDirective headerText="Table" field='_id' width='100' textAlign="Right" />
